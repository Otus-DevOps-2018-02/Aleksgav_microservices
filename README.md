...
# Homework 25
  ...
  - Установил Helm
  - Создал чарты для компонентов ui, comment, post приложения
  - Шаблонизировал созданные чарты
  - Установил и проверил работоспособность нескольких релизов ui
  - Создал функции хэлперы для шаблонов
  - Установил приложение в GKE
  - Установил Gitlab
  - Оправил все репозитории с частями проекта в Gitlab
  - Настроил CI
  - Добавил возможность запускать отдельное окружение в куьернетес по коммиту в feature бранч
...
# Homework 23
  ...
  - Установил kubectl
  - Установил minikube
  - Запустил minikube кластер
  - Описал приложение в yaml манифестах
  - Поднял приложение в minikube
  - Зашел в дэшбоард в minikube
  - Создал неймспейс dev
  - Запусти приложение в неймспейсе dev
  - Добавил информацию о окружении в ui deployment манифест
  - Создал kubernetes кластер в gke
  - Запустил приложение в gke
  - Создал правило брэндауэра для достпа к приложению извне
...
# Homework 21
  ...
  - Создал compose фаил для логирования
  - Создал образ fluentd с необходимыми настройкаим
  - Настроил отпрвку логов в fluentd
  - Протестировал настройки в Kibana
  - Добавил логирование ui сервиса
  - Создал фильтр на основе регулярных вражений в fluentd
  - Создал фильтр на основе grok в fluentd
  
#### Задание со *
  - Добавил в fluentd конфигурацию для разбора неструктурированных логов в нескольких форматах

#### Задание с ***
  - Разобрался с темой распределенного трейсинга
  - Решил пробоему с сервисом post
    - В python 3 в 53 строке, должно быть по явное приведение body = '\x0c\x00\x00\x00\x01'.encode('utf-8') + encoded_span
    иначае сервис просто не стартует
    - В 167 строке стоит time.sleep(3)  
